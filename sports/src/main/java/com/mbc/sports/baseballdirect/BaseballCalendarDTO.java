...
public class BaseballCalendarDTO {
	String TRNAME, TRDATE, TRDATE2, TRMEMBER, TRPLACE, TRCONTENT, TRMEMO;
	int TRNUM;
	String TRINFO;

	public BaseballCalendarDTO() {}
	public BaseballCalendarDTO(String tRNAME, String tRDATE, String tRDATE2, String tRMEMBER, String tRPLACE,
