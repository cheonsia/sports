		        ...
		        function calMoveEvtFn() {
		            ...
		            $(".custom_calendar_table").on("click", "td", function () {
			            ...
			            var yy = $('#calendar_choosed_yy').val();
			   			...
			   			var date = yy + '-' + mm + '-' + dd;
						location.href='soccer_schedule_date?date='+date;	   			
		           });
						...
						<!-- 경기일정 표시화면 -->
								<c:forEach items="${datelist}" var="date">
									<div class="game">
										...
										<div class="imagegame">
											<img alt="" src="./image/soccer/logo/${date.team1}.png" width="50px">
											<span> vs </span>
											<img alt="" src="./image/soccer/logo/${date.team2}.png" width="50px">
										</div>
        ...
        <div class="traning_pop_whole">
        	...
        	<div class="traning_pop_box">
        		...
        		<div class="traning_pop_inner">
	        		<form action="soccerGameSchedule" method="post">
