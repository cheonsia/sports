	        			...
	        			<p class="traning_choose_pop_title">훈련 인원 선택</p>
	       				<div class="traning_people_choose">
	       					<label for="traning_people_select1">
	       						<input type="radio" id="traning_people_select1" name="traning_people_select" value="전체" checked hidden>
	       						<span>전체</span>
	       					</label>
	       					<label for="traning_people_select2">
	       						<input type="radio" id="traning_people_select2" name="traning_people_select" value="선택" hidden>
	       						<span>선택</span>
	       					</label>
	       				</div>
	       				<div class="traning_people_list">
	       					<div>
	       						...
	       						<c:forEach items="${player_list}" var="my" begin="1" step="1">
	       							<div>
			       						<label for="traning_player_choose${my}">
			       							<input type="checkbox" id="traning_player_choose${my}" name="traning_player_choose" value="${my.pname}" hidden>
			       							<span>
