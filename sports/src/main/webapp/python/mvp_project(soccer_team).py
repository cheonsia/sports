...
c.execute("select team,count(team) from sportsmember where sport='축구' group by team order by team")
soccer=c.fetchall()
steam=[]
slike=[]
for i in soccer:
...
autotexts=plt.title('축구 팀 선호표')
color=['#DD582670','#FDD15170','#0E284570','#9ACEE370','#55102A70','#BB1C2270','#093A6D70','#0E284570','#004F9E70','#00513D70','#EE762370','#00000070']
